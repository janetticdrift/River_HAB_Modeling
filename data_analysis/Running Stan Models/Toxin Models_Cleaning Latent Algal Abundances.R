...
algaemodelAll <- readRDS(here::here("data/Outputs for Obs vs Real/Riverwide_AllVariables.rds"))
algaemodelBiotic <- readRDS(here::here("data/Outputs for Obs vs Real/Riverwide_Biotic.rds"))
algaemodelAbiotic <- readRDS(here::here("data/Outputs for Obs vs Real/Riverwide_Abiotic.rds"))
algaemodelAbioticnonut <- readRDS(here::here("data/Outputs for Obs vs Real/Riverwide_Abiotic_nonut.rds"))
algaemodelTrueAbiotic <- readRDS(here::here("data/Outputs for Obs vs Real/Riverwide_TrueAbiotic.rds"))
...
for (name in names(abundances_list)) {
  ...
  X2TM_list[[name]] <- cbind(
    intercept = 1,
    River_latent[-c(14:15, 29:30), -1],  #Abundances are NOT log-transformed
  ...
  if(name == "All"){
    X2TAC <- cbind(
      intercept = 1,
      River_latent[-c(1:2, 14:16, 29:33, 41:45), -1],  #Abundances are NOT log-transformed
